...
class DockingCharger(object):
    ...
    def execute_cb(self, goal):
        ...
        if "position" in data_dict["params"] and "properties" in data_dict["params"]["position"]:
            # Add property to control USE_DOCKING_BY_MIRROR
            if "use_mirror" in data_dict["params"]["position"]["properties"]:
                USE_DOCKING_BY_MIRROR = data_dict["params"]["position"]["properties"]["use_mirror"]
            ...
            if "offset_x" in data_dict["params"]["position"]["properties"]:
                try:
                    additional_offset_x = float(data_dict["params"]["position"]["properties"]["offset_x"])
            ...
            if "offset_y" in data_dict["params"]["position"]["properties"]:
                try:
                    additional_offset_y = float(data_dict["params"]["position"]["properties"]["offset_y"])
